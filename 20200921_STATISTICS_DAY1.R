# [ 1. 확률 ]
# 1.1 확률 실험 : E
# - 어떤 실험을 통한 결과를 예측할 수 없음
# - 결과는 알지 못하지만 발생 가능한 집합은 알고 있는 경우
# - 동일한 실험을 반복할 수 있음
# 예) 동전 던지기 실험
...
# -------------------------------연 습 문 제------------------------------------
# 연습문제 1. 성공확률이 0.3인 확률실험(베르누이 시행)에서 총 5, 10, 30회 반복했을 경우
...
# 2) n = 10
y2 = dbinom(0:10, 10, 0.3)

# 3) n = 30
y3 = dbinom(0:30, 30, 0.3)
...
lines(0:10, y2, type = 'l', col = 2)
lines(0:30, y3, type = 'l', col = 2)
